...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 05, 2025 at 05:28 AM
...
INSERT INTO `barang` (`id_barang`, `nama`, `kategori`, `harga`, `stock`, `tgl_expired`) VALUES
...
--
ALTER TABLE `detail_transaksi`
  ADD CONSTRAINT `fk_idbarang_detail` FOREIGN KEY (`id_barang`) REFERENCES `barang` (`id_barang`),
