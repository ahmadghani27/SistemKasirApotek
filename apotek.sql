...
--
-- Dumping data untuk `pengguna`
--
INSERT INTO `pengguna` (`id_pengguna`, `nama`, `pass`, `telp`, `role`, `username`, `isActive`) VALUES
(1, 'Nizar Retisalya Sulkazimah', '12345678', '081227709133', 'Admin', 'retisalya123', 1);
...
--
-- Struktur tabel untuk `detail_transaksi`
--
...
--
-- Konstrain untuk `detail_transaksi`
--
ALTER TABLE `detail_transaksi`
